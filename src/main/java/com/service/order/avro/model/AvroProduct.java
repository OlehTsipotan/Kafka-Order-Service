...
public class AvroProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8353972343356093760L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroProduct\",\"namespace\":\"com.service.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"long\"}]}");
   ...
   */
  public static com.service.order.avro.model.AvroProduct.Builder newBuilder() {
    return new com.service.order.avro.model.AvroProduct.Builder();
  }
   ...
   * @return A new AvroProduct RecordBuilder
   */
  public static com.service.order.avro.model.AvroProduct.Builder newBuilder(com.service.order.avro.model.AvroProduct.Builder other) {
    if (other == null) {
      return new com.service.order.avro.model.AvroProduct.Builder();
    } else {
      return new com.service.order.avro.model.AvroProduct.Builder(other);
    }
  }
   ...
   * @return A new AvroProduct RecordBuilder
   */
  public static com.service.order.avro.model.AvroProduct.Builder newBuilder(com.service.order.avro.model.AvroProduct other) {
    if (other == null) {
      return new com.service.order.avro.model.AvroProduct.Builder();
    } else {
      return new com.service.order.avro.model.AvroProduct.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroProduct>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.service.order.avro.model.AvroProduct.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.service.order.avro.model.AvroProduct other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder setPrice(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroProduct.Builder clearPrice() {
