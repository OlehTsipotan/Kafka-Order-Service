 ...
 */
package com.service.order.avro.model;
...
public class AvroOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.service.order.avro.model.AvroProduct product;
  private com.service.order.avro.model.AvroOrderStatus status;
   ...
   */
  public AvroOrder(java.lang.CharSequence id, java.lang.Long customerId, com.service.order.avro.model.AvroProduct product, com.service.order.avro.model.AvroOrderStatus status, java.lang.CharSequence source) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: product = (com.service.order.avro.model.AvroProduct)value$; break;
    case 3: status = (com.service.order.avro.model.AvroOrderStatus)value$; break;
   ...
   */
  public com.service.order.avro.model.AvroProduct getProduct() {
    return product;
  }
   ...
   * @param value the value to set.
   */
  public void setProduct(com.service.order.avro.model.AvroProduct value) {
    this.product = value;
  }
   ...
   */
  public com.service.order.avro.model.AvroOrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.service.order.avro.model.AvroOrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static com.service.order.avro.model.AvroOrder.Builder newBuilder() {
    return new com.service.order.avro.model.AvroOrder.Builder();
  }
   ...
   * @return A new AvroOrder RecordBuilder
   */
  public static com.service.order.avro.model.AvroOrder.Builder newBuilder(com.service.order.avro.model.AvroOrder.Builder other) {
    if (other == null) {
      return new com.service.order.avro.model.AvroOrder.Builder();
    } else {
      return new com.service.order.avro.model.AvroOrder.Builder(other);
    }
  }
   ...
   * @return A new AvroOrder RecordBuilder
   */
  public static com.service.order.avro.model.AvroOrder.Builder newBuilder(com.service.order.avro.model.AvroOrder other) {
    if (other == null) {
      return new com.service.order.avro.model.AvroOrder.Builder();
    } else {
      return new com.service.order.avro.model.AvroOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroOrder>
    ...
    private java.lang.Long customerId;
    private com.service.order.avro.model.AvroProduct product;
    private com.service.order.avro.model.AvroProduct.Builder productBuilder;
    private com.service.order.avro.model.AvroOrderStatus status;
    private java.lang.CharSequence source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.service.order.avro.model.AvroOrder.Builder other) {
      super(other);
      ...
      if (other.hasProductBuilder()) {
        this.productBuilder = com.service.order.avro.model.AvroProduct.newBuilder(other.getProductBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.service.order.avro.model.AvroOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder setCustomerId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder setProduct(com.service.order.avro.model.AvroProduct value) {
     ...
     * @return This builder.
     */
    public com.service.order.avro.model.AvroProduct.Builder getProductBuilder() {
      if (productBuilder == null) {
        if (hasProduct()) {
          setProductBuilder(com.service.order.avro.model.AvroProduct.newBuilder(product));
        } else {
          setProductBuilder(com.service.order.avro.model.AvroProduct.newBuilder());
        }
      }
    ...
    public com.service.order.avro.model.AvroOrder.Builder setProductBuilder(com.service.order.avro.model.AvroProduct.Builder value) {
      clearProduct();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder clearProduct() {
      product = null;
      productBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder setStatus(com.service.order.avro.model.AvroOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder setSource(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.service.order.avro.model.AvroOrder.Builder clearSource() {
      source = null;
    ...
    public AvroOrder build() {
      try {
        ...
        if (productBuilder != null) {
          ...
          record.product = fieldSetFlags()[2] ? this.product : (com.service.order.avro.model.AvroProduct) defaultValue(fields()[2]);
        }
        record.status = fieldSetFlags()[3] ? this.status : (com.service.order.avro.model.AvroOrderStatus) defaultValue(fields()[3]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.product == null) {
          this.product = new com.service.order.avro.model.AvroProduct();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        this.status = com.service.order.avro.model.AvroOrderStatus.values()[in.readEnum()];
      }
